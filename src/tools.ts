...
const PRECEPT_API_URL = process.env.PRECEPT_API_URL || "https://api.preceptai.co.uk";
...
const enrichmentsSchema = z.object({
  ...
  decisionMakersLimit: z.number().optional().describe(
  ...
  server.registerTool(
    "precept_search_leads",
    {
      ...
      inputSchema: z.object({
        ...
        postInteractionKeywords: z.array(z.string()).max(5).optional().describe(
  ...
  server.registerTool(
    "precept_enrich_leads",
    {
      ...
      inputSchema: z.object({
        leads: z.array(
          z.object({
            linkedinUrl: z.string().optional().describe(
            ...
            companyName: z.string().optional().describe("Name of the company where the contact works."),
            companyDomain: z.string().optional().describe("Domain of the company (e.g. 'stripe.com')."),
            enrichType: z.array(z.enum(["emails", "phones"])).optional().describe(
              "Type of contact details to find for this lead. Options: 'emails', 'phones'. Default: both."
            ),
            customData: z.record(z.string()).optional().describe(
        ...
        translate: z.boolean().optional().describe(
      ...
      inputSchema: z.object({
        companies: z.array(
          z.object({
            ...
            companyWebsite: z.string().optional().describe("The official website URL or domain (e.g. 'stripe.com' or 'https://stripe.com')."),
            companyLinkedin: z.string().optional().describe("The LinkedIn company page URL (e.g. 'https://linkedin.com/company/stripe')."),
            customData: z.record(z.string()).optional().describe(
